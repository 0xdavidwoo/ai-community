...
export default function LegacyRouteNotice() {
  return (
    <>
      <Head>
        <title>Community Content | AI Forge</title>
      </Head>
      <main className="min-h-screen bg-slate-50 px-4 py-10 sm:px-6">
        <div className="mx-auto max-w-2xl rounded-2xl border border-slate-200 bg-white p-6 text-slate-900">
          ...
          <p className="mt-3 text-sm text-slate-600">
            This project has been rebuilt into the AI Forge (造物社) content aggregation platform and is no longer a tools directory.
          </p>
